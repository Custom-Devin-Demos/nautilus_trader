...
class OrderMatchingEngineConfig:
    def __init__(
        self,
    ...
    @property
    def price_protection_points(self) -> int | None: ...
...
class OrderMatchingEngine:
    ...
    def process_quote_tick(self, quote: QuoteTick) -> None: ...
    def process_trade_tick(self, trade: TradeTick) -> None: ...
    def process_bar(self, bar: Bar) -> None: ...
    def process_status(self, action: MarketStatusAction) -> None: ...
    ...
    def process_order(self, order: Any, account_id: AccountId) -> None: ...
    ...
    def iterate(self, ts_ns: int, aggressor_side: AggressorSide) -> None: ...
    ...
    def get_open_bid_orders(self) -> list[Any]: ...
    def get_open_ask_orders(self) -> list[Any]: ...
    def order_exists(self, client_order_id: ClientOrderId) -> bool: ...
    def get_order(self, client_order_id: ClientOrderId) -> Any | None: ...
